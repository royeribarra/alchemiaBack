...
export class init1685577780354 implements MigrationInterface {
    name = 'init1685577780354'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`pedidos\` ADD CONSTRAINT \`FK_185cc32b32bbc86fb367112dc0f\` FOREIGN KEY (\`transaction_id\`) REFERENCES \`payutransactions\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`pedidos\` DROP FOREIGN KEY \`FK_185cc32b32bbc86fb367112dc0f\``);
        ...
        await queryRunner.query(`DROP INDEX \`REL_185cc32b32bbc86fb367112dc0\` ON \`pedidos\``);
